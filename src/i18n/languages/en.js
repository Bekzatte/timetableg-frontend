export default {
    ...
    dataDiagnosticsDescription:
      "The report loads automatically from current ROP, IUP, sections, teachers, and rooms data.",
    ...
    globalLoaderDefaultDescription: "Please wait. The operation is running and the interface is temporarily blocked.",
    ...
    globalLoaderExportDescription: "Preparing the file for export.",
    loading: "Loading...",
    error: "Error",
    success: "Success",
