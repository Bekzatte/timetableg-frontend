export default {
    ...
    scheduleGenerationInfoIntro:
      "Іске қосар алдында жүйе таңдалған семестр секцияларын, оқытушыларды, қолжетімді аудиторияларды, аудитория блокировкаларын, топшаларды және оқытушының бекітілген қалауларын ескереді. Алдыңғы пакеттердегі бос емес слоттар келесі пакеттерге шектеу ретінде беріледі.",
    scheduleGenerationGreedyInfo:
      "Greedy — жылдам режим. Ол сабақтарды кезекпен қояды: алдымен лекциялар, кейін практикалық және зертханалық сабақтар. Бұл кезде оқытушының, топтың, топшаның және аудиторияның бос болуын тексереді. Алғашқы орналастырудан кейін күндер бойынша жүктемені теңестіруге тырысады.",
    scheduleGenerationCpSatInfo:
      "CP-SAT — дәлірек режим. Ол математикалық модель құрып, сыйымдылық, аудитория түрі, компьютер саны, топ тілі, лекцияның практика/зертханадан бұрын болуы, аудитория блокировкалары, оқытушы лимиттері және қалаулар сияқты шектеулерді ескеріп, ең жақсы мүмкін кестені іздейді.",
    scheduleGenerationHybridInfo:
      "Hybrid алдымен CP-SAT режимін қолданады. Егер шешім табылмаса немесе оптимизатор қолжетімсіз болса, жүйе Greedy режиміне ауысады.",
    scheduleGenerationInfoNote:
      "CP-SAT ұзақтау жұмыс істеуі мүмкін, бірақ әдетте сапалырақ кесте береді. Greedy жылдамырақ және нәтижені ұзақ күтпей алу керек болғанда ыңғайлы.",
    day: "Күн",
    ...
    dataDiagnosticsDescription:
      "Есеп ағымдағы РОП, ИУП, секциялар, оқытушылар және аудиториялар деректері бойынша автоматты жүктеледі.",
    ...
    globalLoaderDefaultDescription: "Күте тұрыңыз. Операция орындалып жатыр, интерфейс уақытша бұғатталды.",
    ...
    globalLoaderExportDescription: "Файл экспортқа дайындалып жатыр.",
    loading: "Жүктелуде...",
    error: "Қате",
    success: "Сәтті",
    noData: "Деректер жоқ",
