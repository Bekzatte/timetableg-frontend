export const translations = {
  kk: {
    ...
    iupImportFileTypeError: "Тек PDF форматындағы ИУП файлдары қолдау табады.",
  ...
  ru: {
    ...
    iupImportFileTypeError: "Поддерживаются только PDF файлы ИУП.",
  ...
  en: {
    ...
    iupImportFileTypeError: "Only IUP PDF files are supported.",
