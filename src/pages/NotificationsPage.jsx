  ...
  return (
    <div className="mx-auto max-w-5xl">
      <div className="rounded-[28px] border border-green-100 bg-white shadow-sm">
        <div className="flex flex-col gap-4 border-b border-green-100 px-5 py-5 sm:flex-row sm:items-center sm:justify-between sm:px-8">
          <div>
          ...
          <div className="flex flex-wrap items-center gap-3">
            {unreadCount > 0 ? (
              <button
                ...
                className="inline-flex items-center justify-center gap-2 rounded-2xl bg-[#014531] px-4 py-3 text-sm font-semibold text-white transition hover:bg-[#026347]"
              >
                <CheckCheck size={18} />
