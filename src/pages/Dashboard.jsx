...
export const Dashboard = () => {
  ...
  const actionButtonClass =
    "inline-flex h-10 min-w-[170px] items-center justify-center rounded-md px-4 py-1 text-center font-medium transition disabled:cursor-not-allowed disabled:opacity-60";
